...
class MainController:
    ...
    def updateForms(self):
        ...
        try:
            ...
            for i in range(min(
                    self.view.max_no_sets, self.matchData.getNoSets())):
                for j in range(2):
            ...
            for i in range(self.matchData.getNoSets()):
                ...
                if found:
                    if(self.view.setScore(i, newscore)):
                        ...
                        continue
            # If not found try again with weak search and
            # set missing playernames
            if not found:
                for i in range(self.matchData.getNoSets()):
                    player1 = self.matchData.getPlayer(0, i)
                    player2 = self.matchData.getPlayer(1, i)
        ...
        for player_idx in range(2):
            ...
            try:
                if tts_active:
                    ...
                    tts_file = 'src/player{}.mp3'.format(player_idx + 1)
