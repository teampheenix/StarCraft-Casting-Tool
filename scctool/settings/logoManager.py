...
module_logger = logging.getLogger('scctool.settings.logoManager')  # create logger
...
class LogoManager:
    ...
    def __init__(self, controller):
        ...
        logo = Logo(self)
        logo.fromURL("http://alpha.tl/logos/269acf64f0db26c38e6278219341711a0c9.png")
    ...
    def removeDuplicates(self):
        all_logos = [self._team1, self._team2] + self._favorites + self._last_used
