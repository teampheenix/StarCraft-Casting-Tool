...
* The Score Icon is now connect via websocket to SCCT and fully animated. [2press]

* Logos and Matchbanner are no longer download if they are identical to the current logos or banner. [2press]

* Restructured the settings. [2press]
...
* Added the GIF format to the list of supported file types for the team logo. [2press]
...
* Fixed a bug that would prevent the Nightbot token from being saved. [2press]
